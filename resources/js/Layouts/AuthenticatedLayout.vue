                ...
                <div class="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center">
                        <div class="flex items-center">
                            <!-- Home link changes based on role -->
                            ...
                            <div class="hidden space-x-8 sm:flex sm:ms-10">
                                ...
                                <Link :href="urls.home" class="text-white hover:text-yellow-300 transition duration-300 ease-in-out text-lg cursor-pointer">
                                Sākums
                                </Link>
                                <Link :href="urls.dienasgramata" class="text-white hover:text-yellow-300 transition duration-300 ease-in-out text-lg cursor-pointer">
                                Dienasgrāmata
                                </Link>
                                <Link :href="urls.kavejumi" class="text-white hover:text-yellow-300 transition duration-300 ease-in-out text-lg cursor-pointer">
                                Kavējumi
                                </Link>
                                <Link :href="urls.atzimes" class="text-white hover:text-yellow-300 transition duration-300 ease-in-out text-lg cursor-pointer">
                                Atzīmes
                                </Link>
...
<script setup>
    ...
    // Define role-based URLs for navigation items
    const urls = computed(() => {
